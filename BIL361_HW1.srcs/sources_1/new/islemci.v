...
module islemci(
    ...
    always @(posedge clk) begin
        if (buyruk[6:0] == 7'b0110111) begin // LUI
            ...
            yazmac_obegi[buyruk[11:7]] = buyruk_adresi + {buyruk[31:12], 12'h0};
        end
        else if (buyruk[6:0] == 7'b1101111) begin // JAL
            yazmac_obegi[buyruk[11:7]] = ps;
            ...
            yazmac_obegi[buyruk[11:7]] = ps;
            if(buyruk[31:31] == 1'b0) begin
                yeni_adres = yazmac_obegi[buyruk[19:15]] + {20'b00000000000000000000, buyruk[31:20]};
            end
            else begin
                yeni_adres = yazmac_obegi[buyruk[19:15]] + {20'b11111111111111111111, buyruk[31:20]};
            end
            ...
            yazmac_obegi[buyruk[11:7]] = veri_bellek[bellek_adresi/4];
        end
            ...
            veri_bellek[bellek_adresi/4] = yazmac_obegi[buyruk[24:20]];
        end
        else if (buyruk[6:0] == 7'b0010011 && buyruk[14:12] == 3'b000) begin // ADDI
            if(buyruk[31:31] == 1'b0) begin
                yazmac_obegi[buyruk[11:7]] = yazmac_obegi[buyruk[19:15]] + {20'b00000000000000000000, buyruk[31:20]};
            end
            else begin
                yazmac_obegi[buyruk[11:7]] = yazmac_obegi[buyruk[19:15]] + {20'b11111111111111111111, buyruk[31:20]};
            end
        end
