...
module tb_islemci();
    ...
    initial begin
        ...
        buyruk_bellegi[6]  <= 32'h00202223;     //  sw x2, 4(x0)   
        buyruk_bellegi[7]  <= 32'h00302423;     //  sw x3, 8(x0)   
        buyruk_bellegi[8]  <= 32'h00402623;     //  sw x4, 12(x0)  
        buyruk_bellegi[9]  <= 32'h00502823;     //  sw x5, 16(x0)  
        buyruk_bellegi[10] <= 32'h01400093;     //  addi x1, x0, 20
        buyruk_bellegi[11] <= 32'h01e00113;     //  addi x2, x0, 30
        buyruk_bellegi[12] <= 32'h02800193;     //  addi x3, x0, 40
        buyruk_bellegi[13] <= 32'h03200213;     //  addi x4, x0, 50
        buyruk_bellegi[14] <= 32'h03c00293;     //  addi x5, x0, 60
        buyruk_bellegi[15] <= 32'h00102a23;     //  sw x1, 20(x0)  
        buyruk_bellegi[16] <= 32'h00202c23;     //  sw x2, 24(x0)  
        buyruk_bellegi[17] <= 32'h00302e23;     //  sw x3, 28(x0)  
        buyruk_bellegi[18] <= 32'h02402023;     //  sw x4, 32(x0)  
        buyruk_bellegi[19] <= 32'h02502223;     //  sw x5, 36(x0)  
        buyruk_bellegi[20] <= 32'h00002083;     //  lw x1, 0(x0)   
        buyruk_bellegi[21] <= 32'h00402103;     //  lw x2, 4(x0)   
        buyruk_bellegi[22] <= 32'h002080b3;     //  add x1, x1, x2 
        buyruk_bellegi[23] <= 32'h00802103;     //  lw x2, 8(x0)   
        buyruk_bellegi[24] <= 32'h002080b3;     //  add x1, x1, x2 
        buyruk_bellegi[25] <= 32'h00c02103;     //  lw x2, 12(x0)  
        buyruk_bellegi[26] <= 32'h002080b3;     //  add x1, x1, x2 
        buyruk_bellegi[27] <= 32'h01002103;     //  lw x2, 16(x0)  
        buyruk_bellegi[28] <= 32'h002080b3;     //  add x1, x1, x2 
        buyruk_bellegi[29] <= 32'h01402103;     //  lw x2, 20(x0)  
        buyruk_bellegi[30] <= 32'h01802183;     //  lw x3, 24(x0)  
        buyruk_bellegi[31] <= 32'h00310133;     //  add x2, x2, x3 
        buyruk_bellegi[32] <= 32'h01c02183;     //  lw x3, 28(x0)  
        buyruk_bellegi[33] <= 32'h00310133;     //  add x2, x2, x3 
        buyruk_bellegi[34] <= 32'h02002183;     //  lw x3, 32(x0)  
        buyruk_bellegi[35] <= 32'h00310133;     //  add x2, x2, x3 
        buyruk_bellegi[36] <= 32'h02402183;     //  lw x3, 36(x0)  
        buyruk_bellegi[37] <= 32'h00310133;     //  add x2, x2, x3 
        buyruk_bellegi[38] <= 32'h401101b3;     //  sub x3, x2, x1 
        buyruk_bellegi[39] <= 32'h1e302e23;     //  sw x3, 508(x0) 
    end
